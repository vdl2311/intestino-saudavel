...
export default function Privacy() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 font-sans text-gray-800 leading-relaxed">
      ...
      <p className="mb-4">Sua privacidade é importante para nós. É política do Protocolo de Bama respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Protocolo de Bama, e outros sites que possuímos e operamos.</p>
      ...
      <p className="mb-4">O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contato pelo e-mail: suporte@protocolodebama.com</p>
